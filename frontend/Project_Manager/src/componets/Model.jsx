    ...
    <div className="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div className='relative bg-[#D4D994] rounded-lg shadow-sm'>
            ...
            <div className='flex items-center justify-between p-4 md:p-5 border-b rounded-t border-red-900'>
                <h3 className='text-lg font-medium text-[#893941]'>
                    {title}
                </h3>

                <button 
                    type= "button"
                    className='text-black bg-transparent hover:bg-[#b2c01d] hover-text-gray-900 rounded-lg text-sm w-8 h-8 inline-flex justify-center items-center cursor-pointer '
                    onClick={onClose}>
