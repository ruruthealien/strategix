      ...
      <table className="min-w-full">
        <thead>
          <tr className="text-left">
            <th className="py-3 px-4 text-gray-600 text-[13px] font-medium">
              Name
            </th>
            <th className="py-3 px-4 text-gray-600 text-[13px] font-medium">
              Status
            ...
            <th className="py-3 px-4 text-gray-600 text-[13px] font-medium hidden md:table-cell">
              Created on
            </th>
          </tr>
        </thead>
        <tbody>
          {tableData.map((task) => (
            <tr key={task._id} className="border-t border-[#893941] ">
              <td className="my-3 mx-4 text-black text-[13px] line-clamp-1 overflow-hidden">
                {task.title}
              </td>
              ...
              <td className="py-4 px-4 text-black text-nowrap hidden md:table-cell text-[13px]">
                {task.createdAt
